...
parser.add_argument("--maxlog", type=int)
parser.add_argument("--rolusr")
parser.add_argument("--rolagt")
parser.add_argument("--iniusr")
parser.add_argument("--iniagt")
parser.add_argument("--nulagt")
parser.add_argument("--sepcnv")
